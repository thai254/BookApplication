...
public class SearchCateAdapter extends RecyclerView.Adapter<SearchCateAdapter.BookViewHolder>{
    private List<SearchDataClass> searchList;
    private Context context;

    public SearchCateAdapter(Context context, List<SearchDataClass> searchList) {
